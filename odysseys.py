...
def get_odyssey (id):
	...
	for dif in ['easy', 'medium', 'hard']:
		...
		# HACK
		if tower_list.startswith(", Quincy, Gwendolin, Jones, Obyn, Silas, Benjamin, Pat, Churchill, Ezili, Rosalia, Etienne, Sauda, Adora, Brickell, Psi, Geraldo, Corvus, Dan D'Monke,"):
			tower_list = tower_list.replace(", Quincy, Gwendolin, Jones, Obyn, Silas, Benjamin, Pat, Churchill, Ezili, Rosalia, Etienne, Sauda, Adora, Brickell, Psi, Geraldo, Corvus, Dan D'Monke,", "All Heroes,")
